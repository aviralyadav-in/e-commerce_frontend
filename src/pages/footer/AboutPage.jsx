    ...
    <main className="min-h-screen bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] transition-colors duration-300">
      ...
      <section>
        <div className="mx-auto flex max-w-6xl flex-col justify-between gap-4 px-5 py-6 sm:px-6 lg:flex-row lg:items-center lg:px-8 lg:py-7">
          ...
          <Link
            to="/shop"
            className="inline-flex w-fit items-center gap-2 border border-[var(--color-text-primary)] px-5 py-2.5 text-sm font-medium text-[var(--color-text-primary)] transition hover:border-[var(--color-accent)] hover:bg-[var(--color-accent)] hover:text-white"
          >
            Shop Collection
      ...
      <section className="overflow-hidden border-t border-[var(--color-border)] bg-[var(--color-bg-secondary)]">
